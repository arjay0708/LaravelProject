                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 text-start" style="line-height:19px; padding-top:1.5rem">
                                            <p class="card-text fw-bold text-center pe-4" style="font-size: 2rem; color:#8d8a85;" id="totalOnGoingReservation"></p>
                            ...
                            <div class="card shadow" style="height:8.1rem; border-radius:10px; background-color:#ffff;">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 text-center" style="line-height:19px; padding-top:1.5rem">
                                            <p class="card-text fw-bold pe-4" style="font-size: 2rem; color:#8d8a85;" id="totalCompletedReservation"></p>
                            ...
                            <div class="card shadow" style="height:8.1rem; border-radius:10px; background-color:#ffff;">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 text-center" style="line-height:19px; padding-top:1.5rem">
                                            <p class="card-text fw-bold pe-2" style="font-size: 2rem; color:#8d8a85;" id="totalCustomer"></p>
