							...
							<div class="tab-content-container">
								<div class="tab-content active show" data-tab-content="tab1">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/restaurant.jpeg" class="img-responsive" alt="Image" style="height: 72%; width:100%;">
											</div>
											<div class="col-md-6">
								...
								<div class="tab-content" data-tab-content="tab2">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/bar.jpeg" class="img-responsive" alt="Image" style="height: 60%; width:100%;">
											</div>
											<div class="col-md-6">
												<span class="super-heading-sm">World Class</span>
								...
								<div class="tab-content" data-tab-content="tab3">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/parking.jpeg" class="img-responsive" alt="Image" style="height: 96%; width:100%;">
											</div>
											<div class="col-md-6">
												<span class="super-heading-sm">World Class</span>
								...
								<div class="tab-content" data-tab-content="tab4">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/pool.jpeg" class="img-responsive" alt="Image" style="height: 80%; width:100%;">
											</div>
											<div class="col-md-6">
												<span class="super-heading-sm">World Class</span>
								...
								<div class="tab-content" data-tab-content="tab5">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/spa.jpg" class="img-responsive" alt="Image" style="height: 70%; width:100%;">
											</div>
											<div class="col-md-6">
												<span class="super-heading-sm">World Class</span>
								...
								<div class="tab-content" data-tab-content="tab6">
									<div class="container">
										<div class="row">
											<div class="col-md-6">
												<img src="img/Gym.jpeg" class="img-responsive" alt="Image" style="height: 70%; width:100%;">
											</div>
											<div class="col-md-6">
												<span class="super-heading-sm">World Class</span>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="copyright">
									...
									Designed by <a href="#" target="_blank">Vince & Reginald</a> <br> Block: <a href="http://unsplash.com/" target="_blank">BSIT 3</a></small></p>
								</div>
							</div>
							<div class="col-md-6">
								<div class="row">
